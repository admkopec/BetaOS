...
static inline void set_cr0(unsigned long value) {
...
static inline unsigned long get_cr3_raw(void) {
    unsigned long cr3;
    __asm__ volatile("mov %%cr3, %0" : "=r" (cr3));
    return(cr3);
}

static inline void set_cr3_raw(unsigned long value) {
    __asm__ volatile("mov %0, %%cr3" : : "r" (value));
}

static inline unsigned long get_cr3_base(void) {
    unsigned long cr3;
    __asm__ volatile("mov %%cr3, %0" : "=r" (cr3));
    return(cr3 & ~(0xFFFULL));
}

static inline void set_cr3_composed(unsigned long base, uint16_t pcid, uint32_t preserve) {
...
static inline void set_cr4(unsigned long value) {
    __asm__ volatile("mov %0, %%cr4" : : "r" (value));
}

static inline unsigned long x86_get_flags(void) {
    unsigned long erflags;
...
static inline void lgdt(unsigned long *desc) {
    __asm__ volatile("lgdt %0" : : "m" (*desc));
}

static inline void lidt(unsigned long *desc) {
