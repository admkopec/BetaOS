...
##TODO:
##
## !! Add makefile from meaty skeleton !!
##
##
...
##exit 2;
##fi
if ! i686-elf-gcc -I ./include -g -O2 -w -trigraphs -ffreestanding -fno-builtin  -fno-exceptions -fno-stack-protector -O0 -m32  -fno-rtti -nostdlib -nodefaultlibs -c kernel.cpp -o build/kernel.o; then
exit 2;
fi
if ! i686-elf-gcc -I ./include -g -O2 -w -trigraphs -ffreestanding -fno-builtin  -fno-exceptions -fno-stack-protector -O0 -m32  -fno-rtti -nostdlib -nodefaultlibs -c ./include/stdio.cpp -o build/stdio.o; then
exit 2;
fi
